...
export const paths: LearningPath[] = [
  {
    ...
    stages: [
      ...
      },
      {
        ...
        description: "Explore in-demand tech fields and find what excites you.",
        sessions: [
          {
            id: "tech-4-1",
            title: "Learn Unity in 17 Minutes",
            description: "Get hands-on with the world's most popular game engine.",
            videoUrl: "https://www.youtube.com/embed/pwXjUNq8VQQ",
            task: "Install Unity Hub, create a 3D project, add a cube, and write a script that rotates it.",
            duration: "~17 min",
          },
          {
            id: "tech-4-2",
            title: "Unreal Engine 5 Starter Course",
            description: "Build photorealistic worlds with the engine behind Fortnite.",
            videoUrl: "https://www.youtube.com/embed/k-zMkzmduqI",
            task: "Build a small outdoor scene with terrain, 3 assets, and one light. Screenshot it.",
            duration: "~60 min",
          },
          {
            id: "tech-4-3",
            title: "How To Make An App — Step by Step",
            description: "The real path from idea to shipped mobile app.",
            videoUrl: "https://www.youtube.com/embed/lFiBLIDpA-c",
            task: "Sketch your app idea on paper: 3 screens, the core action, the target user.",
            duration: "~8 min",
          },
          {
            id: "tech-4-4",
            title: "UI vs UX — What's the Difference?",
            description: "Understand the two sides of digital product design.",
            videoUrl: "https://www.youtube.com/embed/5CxXhyhT6Fc",
            task: "Pick an app you use daily. Write 3 UI critiques and 3 UX critiques.",
            duration: "~6 min",
          },
          {
            id: "tech-4-5",
            title: "Cybersecurity in 7 Minutes",
            description: "Learn how attacks happen and how defenders think.",
            videoUrl: "https://www.youtube.com/embed/inWWhr5tnEA",
            task: "Audit your accounts — enable 2FA on your email and one social account today.",
            duration: "~7 min",
          },
          {
            id: "tech-4-6",
            title: "But What Is a Neural Network?",
            description: "The clearest visual explanation of how AI actually works.",
            videoUrl: "https://www.youtube.com/embed/aircAruvnKk",
            task: "Open ChatGPT or Gemini and write 3 prompts that automate something tedious in your week.",
            duration: "~19 min",
          },
        ],
      },
...

  {
    ...
    stages: [
      ...
      {
        id: "biz-modern",
        title: "Modern Business Skills",
        description: "The practical skills every entrepreneur needs today.",
        sessions: [
          {
            id: "biz-4-1",
            title: "Why Startups Succeed",
            description: "Bill Gross's data-backed take on what really matters.",
            videoUrl: "https://www.youtube.com/embed/bNpx7gpSqbY",
            task: "Write down a startup idea and rate it 1–10 on timing, team, idea, business model, and funding.",
            duration: "~6 min",
          },
          {
            id: "biz-4-2",
            title: "Digital Marketing in 5 Minutes",
            description: "Map the entire marketing landscape in one sitting.",
            videoUrl: "https://www.youtube.com/embed/bixR-KIJKYM",
            task: "Pick one channel (SEO, social, email, content) and list 3 brands doing it well.",
            duration: "~5 min",
          },
          {
            id: "biz-4-3",
            title: "Start an E-commerce Business",
            description: "Step-by-step from niche to first sale.",
            videoUrl: "https://www.youtube.com/embed/QF7lOagwLgE",
            task: "Brainstorm 5 product niches you genuinely understand or care about.",
            duration: "~10 min",
          },
          {
            id: "biz-4-4",
            title: "How to Start a YouTube Channel",
            description: "Ali Abdaal's realistic guide from someone who built 5M+ subs.",
            videoUrl: "https://www.youtube.com/embed/zlcZVZRSj_E",
            task: "Define your channel: niche, target viewer, and your first 3 video titles.",
            duration: "~10 min",
          },
          {
            id: "biz-4-5",
            title: "The 50/30/20 Budgeting Rule",
            description: "The simplest personal finance framework that actually works.",
            videoUrl: "https://www.youtube.com/embed/HQzoZfc3GwQ",
            task: "Track last month's spending and bucket every expense into Needs, Wants, or Savings.",
            duration: "~6 min",
          },
        ],
      },
