        ...
        lessons: [
          {
            ...
            intro: "Every website you visit \u2014 YouTube, Safaricom, even this one \u2014 is built with three core languages: HTML for structure, CSS for style, JavaScript for behaviour. You don't need a fancy laptop or a paid course to start. A free browser and a text editor are enough.",
            description: "Understand what builds the web.",
            videoUrl: yt("ZxKM3DCV2kE"),
            challenge: "Open any 3 websites you use daily. Note one thing each does well in design or layout.",
            duration: "~5 min"
          },
          {
            id: "web-2",
            title: "Your First HTML Page",
            intro: "HTML is just text with tags. <h1> for big titles, <p> for paragraphs. That's it for now. You can write HTML in any text editor \u2014 even Notepad \u2014 save it as index.html, and open it in your browser.",
            description: "Write your first webpage.",
            videoUrl: yt("salY_Sm6mv4"),
            challenge: "Create a file called about-me.html with a heading, a paragraph about you, and one image. Open it in your browser.",
            duration: "~3 min"
          },
          {
            id: "web-3",
            title: "Styling with CSS",
            intro: "CSS makes things look good \u2014 colours, fonts, spacing, layout. The same HTML page can look completely different just by changing CSS. Don't try to learn every property; learn by tweaking.",
            description: "Add colour, fonts and layout.",
            videoUrl: yt("OEV8gMkCHXQ"),
            challenge: "Add a <style> block to your about-me.html. Change the background colour, font, and heading colour.",
            duration: "~4 min"
          },
          {
            id: "web-4",
            title: "JavaScript Basics",
            intro: "JavaScript makes pages interactive \u2014 buttons that do things, forms that respond, content that updates. You don't need to master it overnight. Start with one button that does one thing.",
          ...
          },
          {
            ...
            intro: "A website only matters when people can visit it. Free tools like GitHub Pages or Netlify let you publish a real, shareable URL in minutes \u2014 no hosting fees, no card needed.",
        ...
        lessons: [
          {
            ...
            intro: "Most games \u2014 even AAA ones \u2014 start with one person, one idea, and a free tool. Tools like Scratch, GDevelop, Godot and Unity are 100% free. The hardest part isn't the engine; it's finishing your first tiny game.",
          ...
          },
          {
            ...
            intro: "Scratch is drag-and-drop coding in your browser. No download, no setup. It's how MIT teaches kids and adults to program. You'll build a real, playable game in under 10 minutes.",
          ...
          },
          {
            ...
            intro: "Great games aren't about graphics \u2014 they're about one core loop that feels good. Jump-and-land, shoot-and-hit, match-and-clear. Before writing more code, design the feel.",
          ...
          },
          {
            ...
            intro: "Unity is the engine behind games on Play Store, Steam, and consoles. It's free for beginners. The interface looks scary at first; this lesson takes you through it calmly.",
          ...
          },
          {
            ...
            intro: "Even a tiny game becomes real once someone else plays it. itch.io lets you publish browser games for free with no approval. One link, one friend playing \u2014 that's your first shipped game.",
        ...
        lessons: [
          {
            ...
            intro: "An app is just a program that runs on a phone. You can build one app that runs on both Android and iPhone using tools like Flutter (by Google) or React Native. No need to learn two languages. Pick one tool \u2014 Flutter is the friendliest start.",
          ...
          },
          {
            ...
            intro: "Setup is the hardest part of app development \u2014 once Flutter is installed, everything else is faster. You need Flutter SDK + Android Studio. On a slow connection it can take 1\u20132 hours, but you only do it once.",
          ...
          },
          {
            ...
            intro: "Everything in Flutter is a 'widget' \u2014 text, buttons, layouts. You build apps by combining widgets like Lego blocks. This sounds abstract until you build one \u2014 then it clicks.",
          ...
          },
          {
            ...
            intro: "Now stitch widgets, screens and a bit of logic into something that feels like a real app. Even a counter, todo or tip-calculator app teaches you 80% of what real production apps use.",
          ...
          },
          {
            ...
            intro: "Building an app you never share is just practice. Getting it on a friend's phone \u2014 even as a test APK \u2014 changes everything. Later you can publish to Play Store (about KSh 3,000 one-time fee).",
        ...
        lessons: [
          {
            ...
            intro: "AI tools like ChatGPT, Claude and Gemini are not magic \u2014 they predict the next likely word based on patterns learned from huge amounts of text. Knowing this changes how you use them: clearer instructions in, better results out.",
          ...
          },
          {
            ...
            intro: "A weak prompt gets a weak answer. A strong prompt sets a role, a task, a format and constraints. 'Write a CV' is weak. 'Act as a Kenyan HR manager. Write a 1-page CV for a Form 4 leaver applying for a sales internship. Use bullet points.' is strong.",
          ...
          },
          {
            ...
            intro: "AI shines at the boring stuff: summarising notes, drafting emails, planning your week, breaking down hard topics. Pick 3 tasks you do weekly and let AI handle the first draft. You edit, you stay in control.",
          ...
          },
          {
            ...
            intro: "Tools like Zapier and Make connect apps together so they do things for you \u2014 like saving every email attachment to Drive automatically. No code required. One automation can save hours every month.",
          ...
          },
          {
            ...
            intro: "People are already paying for AI-assisted work \u2014 content drafting, image generation, custom GPTs, lead research. You don't need to be an expert; you need to be useful to a specific person with a specific problem.",
        ...
        lessons: [
          {
            ...
            intro: "UI is how it looks. UX is how it works. A pretty app nobody can use has good UI and bad UX. A clunky-looking app you can't stop using has bad UI and great UX. The best products nail both.",
          ...
          },
          {
            ...
            intro: "Figma is the design tool the whole industry uses. It's free, works in your browser (even on weak laptops), and is the only design tool you need to know for the next few years.",
          ...
          },
          {
            ...
            intro: "Once you've poked around, this longer course teaches frames, components, auto-layout and prototyping \u2014 the four superpowers of Figma. You don't need to watch it all at once.",
          ...
          },
          {
            ...
            intro: "Designing a full landing page forces you to use everything: grids, typography, color, hierarchy. The point isn't perfection \u2014 it's making 100 small decisions and learning from each one.",
          ...
          },
          {
            ...
            intro: "Designers get hired from portfolios, not certificates. 3 strong projects beat 10 weak ones. Show your thinking \u2014 not just final screens.",
        ...
        lessons: [
          {
            ...
            intro: "Cybersecurity is the job of keeping data, money and identities safe from people trying to steal them. Every bank, hospital and school in Kenya now hires for this. It's not just hacking \u2014 it's defence.",
          ...
          },
          {
            ...
            intro: "Modern computers can guess billions of passwords per second. 'Password123' lasts 0.1 seconds. A long passphrase (4 random words) lasts longer than your lifetime. This one habit blocks 80% of real attacks.",
          ...
          },
          {
            ...
            intro: "Seeing the actual cracking process \u2014 billions of guesses per second on a GPU \u2014 makes you take security seriously for life. It's also the foundation for understanding why hashing, salting and 2FA exist.",
          ...
          },
          {
            ...
            intro: "Most real-world breaches don't use crazy hacking \u2014 they use phishing: fake emails, fake M-Pesa SMS, fake job offers. Seeing how easy these are to make is the best vaccine against falling for them.",
          ...
          },
          {
            ...
            intro: "Cybersecurity has more open jobs than people to fill them \u2014 globally and in Kenya. The Google Cybersecurity Certificate is a real, recognised entry point. This intro shows you exactly what the field looks like.",
        ...
        lessons: [
          {
            ...
            intro: "Freelancing means selling a skill directly to clients \u2014 no boss, no office. People in Kenya freelance in writing, design, video editing, virtual assistance, coding. Start with one skill, one platform, one client.",
          ...
          },
          {
            ...
            intro: "You don't need to be an expert. You need to be slightly ahead of your client. Pick the skill where you have the smallest gap to bridge and where buyers exist \u2014 writing, simple design, basic video editing, data entry.",
          ...
          },
          {
            ...
            intro: "Both platforms work from Kenya and pay via M-Pesa-friendly methods. Fiverr is easier to start (you set what you offer). Upwork takes longer to get approved but pays better. Many Kenyans use both.",
          ...
          },
          {
            ...
            intro: "Clients scan, they don't read. Your title, image, and first sentence do 90% of the work. Steal structure from top-rated gigs in your category \u2014 don't copy text, copy the format.",
          ...
          },
          {
            ...
            intro: "The first client is the hardest. Most beginners get theirs by pricing low, replying fast, and over-delivering on one small job. Once you have one 5-star review, the next jobs come easier.",
        ...
        lessons: [
          {
            ...
            intro: "Content creation isn't just for famous people. Small accounts (under 10k followers) often earn from brand deals, affiliate links, services, and digital products. The trick is consistency on one platform with one clear topic.",
          ...
          },
          {
            ...
            intro: "Niches grow faster than general accounts. 'Cooking Kenyan student meals' beats 'cooking'. 'Tech tips for high schoolers' beats 'tech'. Pick a topic you can post about for 30 days without getting bored.",
          ...
          },
          {
            ...
            intro: "The first 3 seconds decide everything. Strong hooks: ask a question, state a bold claim, show the end result first, or break a pattern. Without a hook, even great content gets scrolled past.",
        ...
        lessons: [
          {
            ...
            intro: "Every successful business answers one question clearly: WHY does this exist? People don't buy what you do, they buy why you do it. This idea \u2014 from Simon Sinek \u2014 has shaped a generation of founders.",
          ...
          },
          {
            ...
            intro: "Most beginner founders fail because they fall in love with an idea nobody wants. The best ideas come from real problems you (or people around you) already have. Michael Seibel from Y Combinator breaks down exactly how to test that.",
          ...
          },
          {
            ...
            intro: "An MVP \u2014 minimum viable product \u2014 is the tiniest version of your idea that proves people want it. It is meant to be ugly, simple and embarrassing. If you wait until it's perfect, you'll never launch.",
          ...
          },
          {
            ...
            intro: "Your first 10 customers won't come from ads \u2014 they'll come from you DM-ing people, calling friends, posting in WhatsApp groups. Founders who can't sell die. Founders who can sell survive long enough to figure the rest out.",
          ...
          },
          {
            ...
            intro: "Once your idea has even one paying customer, register it. In Kenya it costs under KSh 1,000 and takes about an hour on eCitizen. You get a real business name, the right to invoice, and the foundation to grow.",
        ...
        lessons: [
          {
            ...
            intro: "Digital marketing is just getting the right message to the right person at the right time \u2014 using the internet. Neil Patel's 10 essentials cover the whole landscape: SEO, email, paid ads, social \u2014 in one short sitting.",
          ...
          },
          {
            ...
            intro: "Every Ksh 1 spent on email returns about Ksh 40. Email isn't dead \u2014 it's just boring and that's why it works. Build a small list early and you own a direct line to your customers that no algorithm can take away.",
        ...
        lessons: [
          {
            ...
            intro: "An online store is 4 simple things: a product, a website, a way to take payment, a way to deliver. That's it. In Kenya you can use Shopify, WooCommerce, or even just a WhatsApp catalog to start.",
          ...
          },
          {
            ...
            intro: "Shopify is the most beginner-friendly way to launch a real store. The free trial is enough to set up everything before you pay a cent. This full walkthrough has helped thousands of people launch.",
          ...
          },
          {
            ...
            intro: "A pretty store doesn't sell \u2014 a CLEAR store sells. Good product photos, simple navigation, trust signals (reviews, return policy), fast checkout. This step-by-step shows you the difference.",
          ...
          },
          {
            ...
            intro: "Once you've launched, this complete guide fills in the gaps \u2014 taxes, shipping zones, apps, abandoned cart emails. Treat it like a reference, not a one-sitting watch.",
          ...
          },
          {
            ...
            intro: "Your first sale is psychologically huge \u2014 and it almost never comes from ads. It comes from your WhatsApp status, your friends, a TikTok. Focus all energy on getting ONE stranger to buy.",
        ...
        lessons: [
          {
            ...
            intro: "The simplest budget on earth: 50% of income to needs, 30% to wants, 20% to savings. It works whether you earn KSh 2,000 a month or KSh 200,000. Master this once and you'll never be broke from confusion again.",
          ...
          },
          {
            ...
            intro: "Money grows on money. KSh 1,000 saved every month at 10% becomes over KSh 2 million in 30 years. Einstein supposedly called compound interest 'the most powerful force in the universe'. Understand it once and you'll save earlier for life.",
        ...
        lessons: [
          {
            ...
            intro: "Graphic design is solving visual problems \u2014 making a poster readable, a logo memorable, a feed beautiful. You don't need talent to start. You need to learn what works and copy structure from designs you admire.",
          ...
          },
          {
            ...
            intro: "Almost every good design uses: alignment, contrast, repetition, hierarchy and white space. Learn these once and you'll see them everywhere \u2014 and your work will instantly improve.",
          ...
          },
          {
            ...
            intro: "Canva is free, runs in your browser, and lets you make professional-looking designs in minutes. Pros use it too \u2014 it's not 'cheating'. Master it before paying for anything fancier.",
          ...
          },
          {
            ...
            intro: "90% of beginner designs look bad because of font choices. Rule: use max 2 fonts. One bold for headings, one clean for body. Stick to fonts already on Canva or Google Fonts.",
          ...
          },
          {
            ...
            intro: "Clients don't hire your CV \u2014 they hire your portfolio. Even 3 strong pieces beat 20 weak ones. Start with fake briefs: redesign a local business's poster, design a logo for your dream brand.",
        ...
        lessons: [
          {
            ...
            intro: "Editing is storytelling with cuts. A good editor turns 30 minutes of raw footage into a 3-minute video people watch to the end. The best editors aren't fast \u2014 they make decisions fast.",
          ...
          },
          {
            ...
            intro: "Cuts hide boredom. B-roll (extra footage shown over the main one) keeps eyes engaged. Pacing \u2014 when to slow down vs speed up \u2014 separates amateur from pro. Watch any pro video with this in mind.",
          ...
          },
          {
            ...
            intro: "Bad video with great audio is watchable. Great video with bad audio gets closed in 5 seconds. Free music (Epidemic Sound trial, YouTube Audio Library) and clean voice recording matter more than 4K footage.",
          ...
          },
          {
            ...
            intro: "DaVinci Resolve is what Hollywood films are edited in \u2014 and the full version is free forever. If you want to edit on a laptop, start here, not in pirated Premiere.",
        ...
        lessons: [
          {
            ...
            intro: "Blender is 100% free, runs on most laptops, and is used to make professional animations, films, and game assets. The famous 'Donut Tutorial' has launched thousands of careers \u2014 and that's exactly where you'll start.",
          ...
          },
          {
            ...
            intro: "Blender looks scary at first \u2014 buttons everywhere. But you only need 6 shortcuts to start: G (grab), R (rotate), S (scale), Tab (edit mode), middle-mouse (orbit), scroll (zoom). Learn these, ignore the rest for now.",
          ...
          },
          {
            ...
            intro: "3D modeling is just pushing vertices, edges and faces around until they look like something. Start with simple shapes \u2014 a mug, a chair, a sword. Don't aim for realism; aim for recognisable.",
          ...
          },
          {
            ...
            intro: "A great model with bad lighting looks fake. A simple model with good lighting looks real. Three-point lighting and one HDRI environment map will instantly upgrade every render you make.",
          ...
          },
          {
            ...
            intro: "ArtStation, Instagram and Reddit (r/blender) are where 3D artists get noticed. One clean render with good lighting beats five rushed ones. Post consistently and you'll get feedback that makes you better.",
        ...
        lessons: [
          {
            ...
            intro: "Every Pixar, Disney and anime animator learns the same 12 principles \u2014 squash & stretch, anticipation, timing. Alan Becker's animated explainer is the best 24-minute crash course on the internet. Watch it once and you'll spot these in every cartoon for the rest of your life.",
          ...
          },
          {
            ...
            intro: "FlipaClip is a free app that lets you animate frame-by-frame on a phone. No tablet, no laptop, no excuses. It's how many young animators got started, including some now working professionally.",
          ...
          },
          {
            ...
            intro: "Once you've made your first bouncing ball, this fuller guide teaches layers, onion-skin, sound and exporting. By the end you'll have everything to make a 30-second short film on your phone.",
          ...
          },
          {
            ...
            intro: "Blender's Grease Pencil turns the famous 3D tool into a full 2D animation studio. It's what many studios use for hybrid 2D/3D work, and it's 100% free forever.",
        ...
        lessons: [
          {
            ...
            intro: "Jamie Windsor is a real photographer who proves that the phone in your pocket is enough to take stunning photos. Lighting, composition and timing matter way more than the camera body itself.",
          ...
          },
          {
            ...
            intro: "Practical mobile photography techniques \u2014 angle, gridlines, HDR, portrait mode. Quick wins you can apply tomorrow on the way to school or work.",
          ...
          },
          {
            ...
            intro: "If you learn only one composition rule, learn this one. Divide the frame into 3x3 and place your subject on the lines or intersections \u2014 instantly more interesting photos.",
          ...
          },
          {
            ...
            intro: "A great edit can turn a 6/10 phone shot into an 8/10 portfolio piece. Snapseed is Google's free pro-grade editor \u2014 and it runs even on entry-level Android phones.",
          ...
          },
          {
            ...
            intro: "A deeper dive into shooting professional-quality phone photography \u2014 from settings to staging. Bring it all together and start posting work people will actually pay for.",
        ...
        lessons: [
          {
            ...
            intro: "You don't need a studio. You don't need a laptop. BandLab is a free app that lets you produce real songs directly on your phone \u2014 drums, melodies, vocals, mixing. It's how thousands of Kenyan producers started.",
          ...
          },
          {
            ...
            intro: "BandLab's official tutorial walks you through every panel: tracks, effects, the mix editor. Take it slow \u2014 pause and try each thing as you go.",
          ...
          },
          {
            ...
            intro: "Theory is fun, but making something is better. This tutorial walks you through producing a complete beat from scratch in BandLab's free web studio. By the end you'll have something you can post.",
          ...
          },
          {
            ...
            intro: "Andrew Huang teaches more usable music theory in 30 minutes than most music schools teach in a term. Scales, chords, keys \u2014 explained so anyone can apply them to a beat tonight.",
